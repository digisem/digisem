...
$string['modulename'] = 'Digitaler Semesterapparat';
$string['modulenameplural'] = 'Digitale Semesterapparate';
$string['modulename_help'] = 'Bestellen Sie Digitalisate von Zeitschriftenaufsätzen oder Buchkapiteln aus dem Bestand der Bibliothek. ';
$string['Digitalization'] = 'Digitalisierung';
$string['Digisem'] = 'Digisem';
$string['pluginadministration'] = 'Administration Digisem';
...
$string['import_from_opac_help'] = 'Recherchieren Sie komfortabel im Online-Katalog (OPAC) die Literaturangaben. ';
...
$string['delivery_email_subject'] = 'UNI/MOODLE: Digitalisierung abgeschlossen';
